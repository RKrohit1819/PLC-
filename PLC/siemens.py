...
'''
# Calculate DMC Length For Reference
print("Calculate DMC Length For Reference")
print("------------------------------")
print(len('111622241062703000'))
print(len(get_string(byte_ar,0)))
print("------------------------------")
#write_int(16,516,6000)
var1=plc.db_read(16,516,2)
print(get_int(var1,0))

#import snap7
#client = snap7.client.Client()
#client.connect("192.168.1.13", 0, 0)
#buffer = client.read_area(snap7.types.Areas.DB, 16, 500, 16) 
#print(buffer)'''
